			...
			<tbody class='progress_bar_tbody'>
				<?php foreach($viewmodel as $item) : ?>
					<tr>
						...
						<td>
							<div class="progress">
								<div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" aria-valuenow="<?php echo $item['opr_level'];?>" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $item['opr_level'].'%';?>">
								</div>
							</div>
